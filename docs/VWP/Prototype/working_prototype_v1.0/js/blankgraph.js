...
OrgChart.prototype.load = function(t) {
    ...
    return (t = t.toString().toLowerCase()).replace(/([� áâãäå])|([ç])|([èéêë])|([ìíîï])|([ñ])|([òóôõöø])|([ß])|([ùúûü])|([ÿ])|([æ])/g, function(t, e, r, i, a, n, o, l, s, h, d) {
