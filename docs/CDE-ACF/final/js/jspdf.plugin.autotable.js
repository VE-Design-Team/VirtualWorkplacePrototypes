...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = factory(require("jspdf"));else if (typeof define === 'function' && define.amd) define(["jspdf"], factory);else {
    var a = (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' ? factory(require("jspdf")) : factory(root["jsPDF"]);
  ...
  return (
    ...
    function (module, exports, __webpack_require__) {
      ...
      function () {
        function Cell(raw, themeStyles, section) {
          ...
          var fromHtml = (typeof window === "undefined" ? "undefined" : _typeof(window)) === 'object' && window.HTMLElement && _instanceof(content, window.HTMLElement);
    ...
    function (module, exports, __webpack_require__) {
      ...
      jsPDF.API.autoTableHtmlToJson = function (tableElem, includeHiddenElements) {
        ...
        if (!tableElem || !_instanceof(tableElem, HTMLTableElement)) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      function drawTable(table) {
        ...
        table.startPageNumber = state_1.default().pageNumber(); // a empty row used to cached cells those break through page
      ...
      exports.drawTable = drawTable; //CE Get the best fit height for a page breaking cell
      ...
      function printFullRow(row, isLastRow, cachedBreakPageRow, rowIndex) {
        ...
        if (remainingPageSpace < row.maxCellHeight) {
          ...
          if (remainingPageSpace < row.height || table.settings.rowPageBreak === 'avoid' && !rowHeightGreaterThanMaxTableHeight(row)) {
            ...
            for (var j = 0; j < table.columns.length; j++) {
              ...
              var vPadding = cell.padding('vertical'); //CE Get actual remaining height for this cell

              var pageBreakColSpanCellHeight = getPageBreakColSpanCellHeight(cell.height, remainingPageSpace, rowIndex, table.body); //CE Remaining Line count should consider actual remaining height for this cell

              var remainingLineCount = Math.floor((pageBreakColSpanCellHeight - vPadding) / fontHeight); // Note that this will cut cells with specified custom min height at page break
        ...
        if (cachedBreakPageRow && !(Object.keys(cachedBreakPageRow.cells).length === 0)) {
          ...
          Object.keys(cachedBreakPageRow.cells).forEach(function (key) {
            cachedBreakPageRow.cells[key].height -= row.height; //Cells smaller then row height doesn't need be maintained.
      ...
      function printRow(row) {
        ...
        row.x = table.cursor.x; // For backwards compatibility reset those after addingRow event
      ...
      function addPage(cachedBreakPageRow, rowIndex) {
        ...
        if (cachedBreakPageRow && !(Object.keys(cachedBreakPageRow.cells).length === 0)) {
          ...
          Object.keys(cachedBreakPageRow.cells).forEach(function (key) {
            ...
            if (cachedBreakPageRow.cells[key].rowSpan > 1) return; // cachedRow height should be equal to the height of non-spanning cells
    ...
    function (module, exports, __webpack_require__) {
      ...
      function parseUserArguments(args) {
        ...
        if (args.length === 1) {
          ...
          var opts = args[2] || {};
          opts.body = args[1];
          opts.columns = args[0]; // Support v2 title prop in v3
      ...
      function parseContent(table) {
        ...
        var _loop_2 = function _loop_2(sectionName) {
          ...
          if (sectionRows.length === 0 && settings.columns) {
            ...
            table.columns.forEach(function (col) {
              ...
              if (sectionName === 'head') {
                var val = _typeof(columnData) === 'object' ? columnData.header : columnData;
        ...
        table.allRows().forEach(function (row) {
          for (var _i = 0, _a = table.columns; _i < _a.length; _i++) {
            var column = _a[_i];
            var cell = row.cells[column.dataKey]; // Kind of make sense to not consider width of cells with colspan columns
      ...
      function default_1(allOptions) {
        var _loop_1 = function _loop_1(settings) {
          if (settings && _typeof(settings) !== 'object') {
            console.error("The options parameter should be of type object, is: " + _typeof(settings));
          }
